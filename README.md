...
- A set of various low-poly 3D props specifically designed to easily fit within Doom II environments. The models use the regular Doom II level textures (referencing them or their patches directly by name).
